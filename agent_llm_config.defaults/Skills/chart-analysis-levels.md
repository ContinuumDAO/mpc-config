...
| **`continuum__analyze_key_level_fibonacci`** | **`key_level_fibonacci`** | `keyLevelFibTradeSetup` | Outer concentric swing range: **0.618** retrace inside range (`kl-fib`), or **1.618 extension** above/below range (`kl-fib-ext`) |
...
- Fib range: `apply_key_level_drawings` with **`fibPairNumber`** (0 / 0.618 / 1 overlay; 1.618 extension line when `targetSource: fib_extension`).
