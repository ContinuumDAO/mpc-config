---
name: chart-analysis-menu
description: Analysis menu / picker guidance (host auto-loads on chart intents)
---
...
- `chart-analysis-liquidity-depth` (averaged spot book walls; **not** a Trade Idea; optional left-axis profile via **`apply_liquidity_depth_drawings`**)
...
- `chart-analysis-moving-averages` (summarize `analyze_moving_averages`; crossover + proximity retest; knobs from **`trade-desk.yaml`**)
