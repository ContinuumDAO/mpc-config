...
| `trade_analysis_cron.example.md` | Copy-paste template for multi-analysis (patterns, momentum, trend, key levels, fib, **Elliott waves**) + optional **`tradeConsensus`** / **`tradeBuild`** YAML; supports **hyperliquid**, **arcus**, **gmx**, **uniswap** execution |
