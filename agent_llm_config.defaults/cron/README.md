...
| `trade_analysis_cron.example.md` | Copy-paste template for multi-analysis (patterns, momentum, trend, key levels, fib) + optional **`tradeConsensus`** / **`tradeBuild`** YAML; supports **hyperliquid**, **gmx**, **uniswap** execution |
