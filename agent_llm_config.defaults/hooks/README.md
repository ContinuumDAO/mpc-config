...
| **`orchestration_hedging.example.md`** | Hedging plan research leaves (`mode: hedging`). Compose is follow-on. |
| **`orchestration_hedging_monitor.example.md`** | Frozen unwind cron message after the hedge is live. |
