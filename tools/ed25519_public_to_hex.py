#!/usr/bin/env python3
"""
Convert Ed25519 public key material to 64 lowercase hex for mpc-auth PublicMgtKey.

Accepts:
  - Full OpenSSH .pub line:  ssh-ed25519 <base64> [optional comment]
  ...
  python3 tools/ed25519_public_to_hex.py ~/.ssh/id_ed25519.pub
  echo 'ssh-ed25519 AAAA... comment' | python3 tools/ed25519_public_to_hex.py
  echo 'AAAAC3NzaC1lZDI1NTE5AAAAI...' | python3 tools/ed25519_public_to_hex.py

For a private key file, use tools/ed25519_private_to_hex.py (64 hex seed)
or tools/ed25519_private_to_pubkey_hex.py (derive public key hex; needs cryptography).
"""
...
def ed25519_public_input_to_hex(line: str) -> str:
...
def openssh_ed25519_input_to_hex(line: str) -> str:
    """Backward-compatible alias for ed25519_public_input_to_hex."""
    return ed25519_public_input_to_hex(line)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Ed25519 public key (OpenSSH line or base64 blob) -> 64 hex PublicMgtKey."
    )
    parser.add_argument(
        "path",
        nargs="?",
    ...
    try:
        for ln in lines:
            print(ed25519_public_input_to_hex(ln))
