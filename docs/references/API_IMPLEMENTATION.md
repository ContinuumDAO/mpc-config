...
| **`agent_llm_config/MCP_default_servers.json`** | Legacy bootstrap file for builtin **continuum** and **coinmarketcap-public** (seeded once by **`process_config.sh`**); used when mpc-auth first migrates/seeds the database. |
